package com.senai.edielsonmariano.projetolistacontatoback;
...
public class ProjetoListaContatoBackApplication {

	public static void main(String[] args) {
		SpringApplication.run(ProjetoListaContatoBackApplication.class, args);
	}
